...
export const buildingAUnits: UnitType[] = [
  ...
  { code: 'CT', description: '2BD Terrace', floors: [0], unitsPerFloor: { 0: 1 } },
  { code: 'CTm', description: '2BD Terrace', floors: [0], unitsPerFloor: { 0: 1 } },
...
export const buildingBUnits: UnitType[] = [
  { code: 'AT', description: 'Studio', floors: [0], unitsPerFloor: { 0: 2 } },
  { code: 'Atm', description: 'Studio', floors: [0], unitsPerFloor: { 0: 2 } },
  { code: 'A', description: 'Studio', floors: [1, 2, 3, 4], unitsPerFloor: { 1: 4, 2: 4, 3: 4, 4: 2 } },
  { code: 'Am', description: 'Studio', floors: [1, 2, 3, 4], unitsPerFloor: { 1: 4, 2: 4, 3: 4, 4: 2 } },
  { code: 'BT', description: 'Studio', floors: [0], unitsPerFloor: { 0: 1 } },
  { code: 'BTm2', description: '2BD Terrace', floors: [0], unitsPerFloor: { 0: 1 } },
  ...
  { code: 'CT', description: '2BD Terrace', floors: [0], unitsPerFloor: { 0: 2 } },
  { code: 'CTm', description: '2BD Terrace', floors: [0], unitsPerFloor: { 0: 2 } },
  ...
  { code: 'DT', description: '1BD', floors: [0], unitsPerFloor: { 0: 4 } },
  { code: 'DTm', description: '1BD', floors: [0], unitsPerFloor: { 0: 4 } },
  ...
  { code: 'ET', description: 'Studio', floors: [0], unitsPerFloor: { 0: 1 } },
  { code: 'Etm', description: 'Studio', floors: [0], unitsPerFloor: { 0: 1 } },
  { code: 'E', description: 'Studio', floors: [1, 2, 3, 4], unitsPerFloor: { 1: 1, 2: 1, 3: 1, 4: 1 } },
  { code: 'Em', description: 'Studio', floors: [1, 2, 3, 4], unitsPerFloor: { 1: 1, 2: 1, 3: 1, 4: 1 } },
  { code: 'F', description: '1BD', floors: [1, 2, 3, 4], unitsPerFloor: { 1: 1, 2: 1, 3: 1, 4: 1 } },
  { code: 'Fm', description: '1BD', floors: [1, 2, 3, 4], unitsPerFloor: { 1: 1, 2: 1, 3: 1, 4: 1 } },
